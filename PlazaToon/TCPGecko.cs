...
namespace PlazaToon
{
    ...
    public class TCPGecko
    {
        ...
        public void Dump(UInt32 startdump, UInt32 enddump, Stream[] saveStream)
        {
            ...
            if (global::PlazaToon.ValidMemory.rangeCheckId(startdump) != global::PlazaToon.ValidMemory.rangeCheckId(enddump))
            {
                enddump = global::PlazaToon.ValidMemory.ValidAreas[global::PlazaToon.ValidMemory.rangeCheckId(startdump)].high;
            }

            if (!global::PlazaToon.ValidMemory.validAddress(startdump)) return;
        ...
        */
        ...
        {
            if (!global::PlazaToon.ValidMemory.validAddress(address))
            {
                return 0;
            }
